...
{
  public class EditorBelt_WWE2K24 : CreationEditor
  {
    ...
    public EditorBelt_WWE2K24.BeltBasicInfo beltPrimaryInfo;
    public EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo;
    ...
    public EditorBelt_WWE2K24.BeltBasicInfo BeltInfo
    {
      get => (EditorBelt_WWE2K24.BeltBasicInfo) this.PrimaryInfoPropertyGrid.SelectedObject;
    }

    public EditorBelt_WWE2K24.BeltMappingInfo BeltMapping
    {
      get => (EditorBelt_WWE2K24.BeltMappingInfo) this.SecondaryInfoPropertyGrid.SelectedObject;
    }

    public EditorBelt_WWE2K24(ILogger inLogger)
      : base(inLogger)
    {
      this.MetaPropertyGridFactory = new MetaPropertyGridFactory();
      this.beltPrimaryInfo = new EditorBelt_WWE2K24.BeltBasicInfo();
      this.beltPrimaryInfo.LoadDefaults();
      this.beltSecondaryInfo = new EditorBelt_WWE2K24.BeltMappingInfo();
      this.beltSecondaryInfo.LoadDefaults();
    }

    static EditorBelt_WWE2K24()
    {
      FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (EditorBelt_WWE2K24), (PropertyMetadata) new FrameworkPropertyMetadata((object) typeof (EditorBelt_WWE2K24)));
    }
    ...
    public void Load(WWE2K24_Generated_Belt Profile)
    {
      this.beltPrimaryInfo = new EditorBelt_WWE2K24.BeltBasicInfo();
      this.beltPrimaryInfo.LoadDefaults();
      this.beltSecondaryInfo = new EditorBelt_WWE2K24.BeltMappingInfo();
      ...
      this.beltPrimaryInfo.BeltSlotID = Profile.BeltDataTable.belt_id;
      ...
      this.beltPrimaryInfo.BeltMovieBK2ID = Profile.BeltDataTable.meta.movie_data_1.bk2;
      ...
      {
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo1 = this.beltSecondaryInfo;
        num = Profile.BeltData_AssetMap.data[0].mdl_path;
        string str1 = num.ToString();
        beltSecondaryInfo1.CutsceneMDLPath = str1;
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo2 = this.beltSecondaryInfo;
      ...
      {
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo3 = this.beltSecondaryInfo;
        num = Profile.BeltData_AssetMap.data[1].mdl_path;
        string str3 = num.ToString();
        beltSecondaryInfo3.DefaultBeltMDLPath = str3;
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo4 = this.beltSecondaryInfo;
        num = Profile.BeltData_AssetMap.data[1].havok_path;
        string str4 = num.ToString();
        beltSecondaryInfo4.DefaultHavokFolderPath = str4;
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo5 = this.beltSecondaryInfo;
        num = Profile.BeltData_AssetMap.data[1].propconfig_global_jsfb;
        string str5 = num.ToString();
        beltSecondaryInfo5.DefaultPropConfigPath = str5;
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo6 = this.beltSecondaryInfo;
      ...
      {
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo7 = this.beltSecondaryInfo;
        num = Profile.BeltData_AssetMap.data[2].mdl_path;
        string str7 = num.ToString();
        beltSecondaryInfo7.LadderMDLPath = str7;
        EditorBelt_WWE2K24.BeltMappingInfo beltSecondaryInfo8 = this.beltSecondaryInfo;
    ...
    public class BeltBasicInfo
    {
      ...
      public uint BeltMovieBK2ID { get; set; } = uint.MaxValue;
