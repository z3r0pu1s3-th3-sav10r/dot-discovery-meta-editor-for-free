...
namespace Meta.Editor.Controls.CreationSuite
{
  ...
  public class EditorMotion_WWE2K24 : CreationEditor
  {
    ...
    private EditorMotion_WWE2K24.MotionPrimary motionPrimaryInfo;
    private EditorMotion_WWE2K24.MotionSecondary motionSecondaryInfo;

    public MetaPropertyGridFactory MetaPropertyGridFactory { get; set; }

    public EditorMotion_WWE2K24.MotionPrimary Primaryinfo => this.motionPrimaryInfo;

    public EditorMotion_WWE2K24.MotionSecondary SecondaryInfo => this.motionSecondaryInfo;

    public override string Title => "Moveset";

    public override string Icon => "MotionSensor";

    public EditorMotion_WWE2K24(ILogger inLogger)
      : base(inLogger)
    {
      this.DataContext = (object) this;
      this.MetaPropertyGridFactory = new MetaPropertyGridFactory();
      this.motionPrimaryInfo = new EditorMotion_WWE2K24.MotionPrimary();
      this.motionSecondaryInfo = new EditorMotion_WWE2K24.MotionSecondary();
    }

    static EditorMotion_WWE2K24()
    {
      FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (EditorMotion_WWE2K24), (PropertyMetadata) new FrameworkPropertyMetadata((object) typeof (EditorMotion_WWE2K24)));
    }
    ...
    public void Load(CharacterProfile_WWE2K24 Profile)
    {
    ...
    public class MotionPrimary : BaseEditor
    {
      ...
      public void SetValue(string category, List<ushort> values)
      {
        ...
        {
          if (Attribute.GetCustomAttribute((MemberInfo) properties[index2], typeof (CategoryAttribute)) is CategoryAttribute customAttribute && customAttribute.Category.Equals(category) && index1 < values.Count)
          {
