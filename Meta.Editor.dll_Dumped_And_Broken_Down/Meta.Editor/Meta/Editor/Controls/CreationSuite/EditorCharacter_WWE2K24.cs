...
namespace Meta.Editor.Controls.CreationSuite
{
  ...
  public class EditorCharacter_WWE2K24 : CreationEditor
  {
    ...
    public EditorCharacter_WWE2K24.CharacterBasicInfo characterPrimaryInfo;
    protected EditorCharacter_WWE2K24.CharacterSecondaryInfo characterSecondaryInfo;
    ...
    public EditorCharacter_WWE2K24.CharacterBasicInfo CharacterInfo
    {
      get => (EditorCharacter_WWE2K24.CharacterBasicInfo) this.BasicInfoPropertyGrid.SelectedObject;
    }

    public EditorCharacter_WWE2K24.CharacterSecondaryInfo CharacterStats
    {
      get
      {
        return (EditorCharacter_WWE2K24.CharacterSecondaryInfo) this.SecondaryInfoPropertyGrid.SelectedObject;
      }
    }

    public EditorCharacter_WWE2K24(ILogger inLogger)
      : base(inLogger)
    {
      this.MetaPropertyGridFactory = new MetaPropertyGridFactory();
      this.characterPrimaryInfo = new EditorCharacter_WWE2K24.CharacterBasicInfo();
      this.characterPrimaryInfo.LoadDefaults();
      this.characterSecondaryInfo = new EditorCharacter_WWE2K24.CharacterSecondaryInfo();
      this.characterSecondaryInfo.LoadDefaults();
    }

    static EditorCharacter_WWE2K24()
    {
      FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (EditorCharacter_WWE2K24), (PropertyMetadata) new FrameworkPropertyMetadata((object) typeof (EditorCharacter_WWE2K24)));
    }
    ...
    public virtual void Load(object characterProfile)
    {
      ...
      if (EditorCharacter_WWE2K24.\u003C\u003Eo__23.\u003C\u003Ep__0 == null)
      {
        // ISSUE: reference to a compiler-generated field
        EditorCharacter_WWE2K24.\u003C\u003Eo__23.\u003C\u003Ep__0 = CallSite<Func<CallSite, object, CharacterProfile_WWE2K24>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (CharacterProfile_WWE2K24), typeof (EditorCharacter_WWE2K24)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      CharacterProfile_WWE2K24 Profile = EditorCharacter_WWE2K24.\u003C\u003Eo__23.\u003C\u003Ep__0.Target((CallSite) EditorCharacter_WWE2K24.\u003C\u003Eo__23.\u003C\u003Ep__0, characterProfile);
      this.characterPrimaryInfo = new EditorCharacter_WWE2K24.CharacterBasicInfo();
      this.characterPrimaryInfo.LoadDefaults();
      this.characterSecondaryInfo = new EditorCharacter_WWE2K24.CharacterSecondaryInfo();
      this.characterSecondaryInfo.LoadDefaults();
      ...
      this.characterPrimaryInfo.WrestlerEntranceFilter = this.characterPrimaryInfo.ScreenFilters.Get<byte>((object) Profile.Motion.screen_effect);
      this.characterPrimaryInfo.WrestlerEntranceLightShow = this.characterPrimaryInfo.LightShows.Get<uint>((object) Profile.Motion.light_show);
      ...
      this.characterPrimaryInfo.WrestlerPayBack1 = this.characterPrimaryInfo.Paybacks.Get<byte>((object) Profile.Info.payback_01);
      this.characterPrimaryInfo.WrestlerPayBack2 = this.characterPrimaryInfo.Paybacks.Get<byte>((object) Profile.Info.payback_02);
    ...
    public class CharacterBasicInfo : BaseEditor
    {
      public CharacterBasicInfo()
      {
        ...
        this.LightShows = JsonConvert.DeserializeObject<ObservableCollection<JObject>>(JsonConvert.SerializeObject(App.FileData[App.Game]["LightShow"]));
      ...
      public void LoadDefaults()
      {
        ...
        this.WrestlerEntranceLightShow = this.LightShows[0];
      ...
      [ItemsSourceProperty("LightShows")]
      [Important]
      public JObject WrestlerEntranceLightShow { get; set; }
      ...
      public uint WrestlerEntranceMovieTitantron { get; set; } = 100;

      [Category("Movies")]
      [DisplayName("Banner")]
      public uint WrestlerEntranceMovieBanner { get; set; } = 100;

      [Category("Movies")]
      [DisplayName("Stage")]
      public uint WrestlerEntranceMovieStageRamp { get; set; } = 100;

      [Category("Movies")]
      [DisplayName("Apron")]
      public uint WrestlerEntranceMovieApronRingPost { get; set; } = 100;

      [Category("Movies")]
      [DisplayName("Barricade")]
      public uint WrestlerEntranceMovieBarricade { get; set; } = 100;
      ...
      [Browsable(false)]
      public ObservableCollection<JObject> LightShows { get; set; }
